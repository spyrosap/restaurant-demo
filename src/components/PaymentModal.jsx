...
export default function PaymentModal({ cart, onClose, onPaymentConfirmed }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => onPaymentConfirmed({ items: cart, total }), 2000);
    return () => clearTimeout(timer);
  }, [step, cart, total, onPaymentConfirmed]);
